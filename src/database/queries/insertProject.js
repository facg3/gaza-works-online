...
const insertProject = (projectObj, cb) => {
  const insertProjectQuery = {
    ...
    values: [projectObj.title, projectObj.userId, projectObj.categoryId, projectObj.skills, projectObj.description, projectObj.budget, projectObj.deadLine, projectObj.lifetime],
  };
